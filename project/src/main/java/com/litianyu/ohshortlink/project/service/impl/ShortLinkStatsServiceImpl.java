...
import com.litianyu.ohshortlink.project.dto.req.ShortLinkGroupStatsAccessRecordReqDTO;
...
import com.litianyu.ohshortlink.project.service.ShortLinkStatsService;
...
public class ShortLinkStatsServiceImpl implements ShortLinkStatsService {
    ...
    public ShortLinkStatsRespDTO oneShortLinkStats(ShortLinkStatsReqDTO requestParam) {
        ...
        int oldUserCnt = Integer.parseInt( // 旧访客
                Optional.ofNullable(findUvTypeByShortLink)
                        .map(each -> each.get("oldUserCnt"))
                        .map(Object::toString)
                        .orElse("0")
        );
        int newUserCnt = Integer.parseInt( // 新访客
                Optional.ofNullable(findUvTypeByShortLink)
